...
% Start this with:
%   swipl server_ceritolog.pl --port 9999 --staticdir static

% TODO: if using daemon:
%         swipl server_ceritolog.pl --port=.... --pidfile=/var/run/simple_server.pid
...
%   http://localhost:9999/static/ceritolog.html
...
:- module(server_ceritolog, [simple_server_main/0, simple_server_impl/1]).
...
% http_absolute_location(static('ceritolog.js'), Path, []), Path='/static/ceritolog.js'.
...
% http://localhost:9999/ ... redirects to /static/ceritolog.html
